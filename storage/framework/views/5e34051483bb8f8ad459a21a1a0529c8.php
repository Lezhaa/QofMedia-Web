...
<section class="division-carousel-section <?php echo e($loop->even ? 'bg-light' : ''); ?>">
    <div class="container">
    ...
    <div class="container">
        <div class="swiper member-swiper" id="divisionSwiper<?php echo e($division->id); ?>">
                    ...
                    <div class="swiper-slide">
                        <div class="member-photo">
                            <?php if($member->photo_url): ?>
                                <img src="<?php echo e($member->photo_url); ?>" alt="<?php echo e($member->name); ?>" loading="lazy">
                            <?php else: ?>
                        ...
                        <div class="member-info">
                            ...
                            <div class="member-social">
                                <a href="<?php echo e($member->social_url ?? '#'); ?>"
                                   ...
                                   title="<?php echo e(ucfirst($member->social_platform)); ?>: <?php echo e($member->social_username); ?>">
