...
<?php $__env->startSection('title', 'Qof Apparel'); ?>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 mb-4">
                <div class="filter-card">
                    ...
                    <ul class="category-list">
                        <li>
                            <a href="<?php echo e(route('service.apparel')); ?>" class="<?php echo e(!request('category') ? 'active' : ''); ?>">
                                Semua Produk
                        ...
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li>
                                <a href="<?php echo e(route('service.apparel', ['category' => $category->id])); ?>"
                                   class="<?php echo e(request('category') == $category->id ? 'active' : ''); ?>">
                                    <?php echo e($category->name); ?>

                                    <span class="badge"><?php echo e($category->products_count); ?></span>
                                </a>
                            </li>
                    ...
                    <select class="sort-select" onchange="window.location.href=this.value">
                        <option value="<?php echo e(route('service.apparel', array_merge(request()->except('sort'), ['sort' => 'latest']))); ?>"
                                <?php echo e(request('sort', 'latest') == 'latest' ? 'selected' : ''); ?>>
                            📅 Terbaru
                        </option>
                        <option value="<?php echo e(route('service.apparel', array_merge(request()->except('sort'), ['sort' => 'price_low']))); ?>"
                                <?php echo e(request('sort') == 'price_low' ? 'selected' : ''); ?>>
                            ⬆️ Harga: Rendah ke Tinggi
                        </option>
                        <option value="<?php echo e(route('service.apparel', array_merge(request()->except('sort'), ['sort' => 'price_high']))); ?>"
            ...
            <div class="col-lg-9">
                ...
                <div class="search-box">
                    ...
                    <input type="text" id="searchInput" placeholder="Cari produk..." value="<?php echo e(request('search')); ?>">
                </div>
                            ...
                            <div class="product-card">
                                <div class="product-image">
                                    ...
                                    <div class="product-category">
                                        <span class="badge-tag category"><?php echo e($product->category->name ?? 'Produk'); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="product-body">
                                    ...
                                    <span class="stock-badge <?php echo e($product->stock > 0 ? 'available' : 'empty'); ?>">
                                        <i class="bi bi-<?php echo e($product->stock > 0 ? 'check-circle' : 'x-circle'); ?> me-1"></i>
                                ...
                                <div class="product-footer">
                                    <a href="<?php echo e(route('apparel.product.show', $product->id)); ?>" class="btn-detail">
                ...
                <?php else: ?>
                    <div class="empty-state">
                        ...
                        <a href="<?php echo e(route('service.apparel')); ?>" class="btn-reset">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\qofmedia-web\resources\views/public/service/apparel/index.blade.php ENDPATH**/ ?>