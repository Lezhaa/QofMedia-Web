        ...
        <div class="dash-card-header">
            <div class="dash-card-title">
                ...
                <span style="background:#EEF9FC; color:#0E7A96; padding:2px 10px; border-radius:50px; font-size:0.72rem; font-weight:700;">
                    <?php echo e(($categories ?? collect())->count()); ?> kategori
                </span>
            </div>
        </div>
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $categories ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td>
                            <div style="font-weight: 700;"><?php echo e($category->name); ?></div>
                        </td>
                        <td>
                        ...
                        <td>
                            <div class="td-muted">
                                <i class="far fa-calendar-alt me-1"></i><?php echo e($category->created_at->format('d M Y')); ?>
