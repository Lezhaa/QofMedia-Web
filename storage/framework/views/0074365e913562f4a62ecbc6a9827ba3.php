...
<?php $__env->startSection('content'); ?>
    ...
    <div class="stats-bar">
        <div class="stat-chip">
            ...
            Total: <strong><?php echo e($articles->total()); ?></strong>
        </div>
        <div class="stat-chip">
            <i class="fas fa-file-alt"></i>
            Halaman ini: <strong><?php echo e($articles->count()); ?></strong>
        </div>
    </div>
    ...
    <div class="filter-bar">
        ...
        <select id="catFilter" onchange="filterRows()">
            ...
            <?php $__currentLoopData = $articles->pluck('category')->unique()->sort(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <table class="articles-table" id="articlesTable">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="art-row"
                                data-title="<?php echo e(strtolower($article->title)); ?>"
                                data-cat="<?php echo e(strtolower($article->category)); ?>">
                                <td style="color:#CBD5E1; font-size:0.8rem; font-weight:600;">
                                    <?php echo e($loop->iteration + ($articles->currentPage() - 1) * $articles->perPage()); ?>

                                </td>
                                <td>
                                    <?php if($article->image ?? false): ?>
                                        <img src="<?php echo e(asset('storage/' . $article->image)); ?>"
                                             class="art-thumb" alt="<?php echo e($article->title); ?>">
                                    <?php else: ?>
                                ...
                                <td style="max-width: 280px;">
                                    <div class="art-title"><?php echo e($article->title); ?></div>
                                    <?php if($article->excerpt ?? false): ?>
                                        <div class="art-excerpt"><?php echo e($article->excerpt); ?></div>
                                    <?php endif; ?>
                                </td>
                                <td>
                                    <span class="badge-cat"><?php echo e($article->category); ?></span>
                                </td>
                                <td>
                                    ...
                                    <div style="display:flex; align-items:center; justify-content:center; gap:6px;">
                                        ...
                                        <form action="<?php echo e(route('admin.articles.destroy', $article)); ?>"
                                            ...
                                            <button type="submit" class="act-btn delete" title="Hapus"
                                                    onclick="return confirm('Yakin ingin menghapus artikel \'<?php echo e(addslashes($article->title)); ?>\'?')">
