<?php $__env->startSection('title', 'Laporan Keuangan Apparel'); ?>
...
<?php $__env->startSection('content_header'); ?>
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
        ...
        <div class="d-flex gap-2">
            <a href="<?php echo e(route('apparel.finance.export-excel')); ?>" 
            ...
            <a href="<?php echo e(route('apparel.finance.export-pdf')); ?>" 
    ...
    <div class="row g-3 mb-4">
        <div class="col-lg-4 col-sm-6">
            <div class="stat-card green">
                ...
                <div class="stat-info">
                    <div class="stat-number">Rp <?php echo e(number_format($totalPendapatan, 0, ',', '.')); ?></div>
        ...
        <div class="col-lg-4 col-sm-6">
            <div class="stat-card" style="--c:#0E7A96;">
                ...
                <div class="stat-info">
                    <div class="stat-number"><?php echo e($orders->total()); ?></div>
        ...
        <div class="col-lg-4 col-sm-6">
            <div class="stat-card" style="--c:#7C3AED;">
                ...
                <div class="stat-info">
                    <div class="stat-number"><?php echo e($chartData->count()); ?></div>
    ...
    <div class="section-card">
        <div class="section-card-header">
            ...
            <span class="badge-success-custom">
                <i class="fas fa-check-circle"></i> <?php echo e($orders->total()); ?> transaksi
            </span>
        </div>
                ...
                <table class="report-table" id="reportTable">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="rpt-row" data-name="<?php echo e(strtolower($order->pemesan_name)); ?>">
                                <td><span class="order-id">#<?php echo e($order->id); ?></span></td>
                                <td><span class="order-name"><?php echo e($order->pemesan_name); ?></span></td>
                                <td>
                                ...
                                <td>
                                    ...
                                    ?>
                                    <?php if($proofPath): ?>
                                        <span class="badge-bukti <?php echo e($proofStatus == 'valid' ? 'valid' : ($proofStatus == 'invalid' ? 'invalid' : 'pending')); ?>">
                                            <?php if($proofStatus == 'valid'): ?>
                                        ...
                                        <a href="<?php echo e(asset('storage/' . $proofPath)); ?>" target="_blank" class="bukti-link" title="Lihat Bukti">
                                ...
                                <td style="text-align: center;">
                                    <a href="<?php echo e(route('apparel.orders.show', $order->id)); ?>" 
...
<script>
    ...
    const labels = <?php echo json_encode($chartData->pluck('month')); ?>;
    const dataValues = <?php echo json_encode($chartData->pluck('total')); ?>;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\qofmedia-web\resources\views/apparel/finances/index.blade.php ENDPATH**/ ?>