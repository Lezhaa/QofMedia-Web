...
<?php $__env->startSection('content'); ?>
    ...
    <div class="welcome-banner">
        <div class="wb-content">
            ...
            <p>Anda login sebagai Administrator QofMedia &mdash; <?php echo e(now()->isoFormat('dddd, D MMMM Y')); ?></p>
            <span class="wb-time">
    ...
    <div class="row g-3 mb-4">
        <div class="col-6 col-lg-3">
            <a href="<?php echo e(route('admin.contacts.index')); ?>" class="stat-card blue d-flex">
                <div class="stat-icon"><i class="fas fa-envelope"></i></div>
                <div class="stat-info">
                    <div class="stat-number"><?php echo e($stats['unread_contacts'] ?? 0); ?></div>
        ...
        <div class="col-6 col-lg-3">
            <a href="<?php echo e(route('admin.articles.index')); ?>" class="stat-card green d-flex">
                <div class="stat-icon"><i class="fas fa-newspaper"></i></div>
                <div class="stat-info">
                    <div class="stat-number"><?php echo e($stats['total_articles'] ?? 0); ?></div>
        ...
        <div class="col-6 col-lg-3">
            <a href="<?php echo e(route('admin.albums.index')); ?>" class="stat-card amber d-flex">
                <div class="stat-icon"><i class="fas fa-images"></i></div>
                <div class="stat-info">
                    <div class="stat-number"><?php echo e($stats['total_albums'] ?? 0); ?></div>
        ...
        <div class="col-6 col-lg-3">
            <a href="<?php echo e(route('admin.users.index')); ?>" class="stat-card red d-flex">
        ...
        <div class="col-lg-6">
            <div class="dash-card">
                <div class="dash-card-header">
                    ...
                    <a href="<?php echo e(route('admin.contacts.index')); ?>" class="dash-card-link">
                ...
                <table class="dash-table">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $recentContacts ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td>
                                    <div style="font-weight: 700; font-size: 0.85rem;"><?php echo e($contact->name); ?></div>
                                    <div class="td-muted"><?php echo e(Str::limit($contact->message, 38)); ?></div>
                                </td>
                                <td>
            ...
            <div class="dash-card">
                <div class="dash-card-header">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <a href="<?php echo e(route('admin.articles.index')); ?>" class="dash-card-link">
                            Lihat semua <i class="fas fa-arrow-right"></i>
                        </a>
                    </div>
                </div>
                <table class="dash-table">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $recentArticles ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td>
                                    <div style="font-weight: 700; font-size: 0.85rem;"><?php echo e(Str::limit($article->title, 36)); ?></div>
                                    <div class="td-muted"><i class="far fa-calendar-alt me-1"></i><?php echo e($article->created_at->format('d M Y')); ?></div>
                                </td>
                                <td><span class="badge-cat"><?php echo e($article->category); ?></span></td>
    ...
    <div class="qa-grid mb-4">
        <a href="<?php echo e(route('admin.articles.create')); ?>" class="qa-btn qa-blue">
            <div class="qa-icon"><i class="fas fa-plus-circle"></i></div>
            <span>Tambah Artikel</span>
        </a>
        <a href="<?php echo e(route('admin.albums.create')); ?>" class="qa-btn qa-green">
            <div class="qa-icon"><i class="fas fa-images"></i></div>
            <span>Tambah Album</span>
        </a>
        <a href="<?php echo e(route('admin.users.index')); ?>" class="qa-btn qa-amber">
            <div class="qa-icon"><i class="fas fa-users-cog"></i></div>
            <span>Manajemen User</span>
        </a>
        <a href="<?php echo e(route('admin.settings.index')); ?>" class="qa-btn qa-slate">
    ...
    <div class="sysinfo-grid">
        ...
        <div class="sysinfo-item">
            ...
            <div>
                ...
                <div class="si-value"><?php echo e($stats['total_users'] ?? 0); ?></div>
            </div>
        </div>
        <div class="sysinfo-item">
