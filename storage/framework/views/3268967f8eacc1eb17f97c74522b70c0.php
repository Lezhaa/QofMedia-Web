    ...
    <div class="d-flex justify-content-between align-items-center">
        <div>
            <h1 class="mb-0" style="font-size: 1.4rem; font-weight: 700; color: #0D1B2A;">
                <i class="fas fa-tshirt me-2" style="color: #0E7A96;"></i> Dashboard Apparel
            </h1>
        ...
        <a href="<?php echo e(route('service.apparel')); ?>" target="_blank"
           style="display:inline-flex; align-items:center; gap:6px; background:#fff; border:1.5px solid #E2E8F0; color:#0E7A96; padding:9px 20px; border-radius:50px; font-weight:700; font-size:0.85rem; text-decoration:none; transition:all 0.3s;">
            <i class="fas fa-globe"></i> Lihat Halaman Apparel
        </a>
    </div>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="welcome-banner">
        <div class="wb-content">
            <h4>Dashboard Apparel 👕</h4>
            <p>Kelola kategori, produk, dan order apparel &mdash; <?php echo e(now()->isoFormat('dddd, D MMMM Y')); ?></p>
            <span class="wb-time">
                <i class="fas fa-circle" style="font-size:0.45rem; animation: blink 2s infinite;"></i>
                Online &bull; <?php echo e(now()->format('H:i')); ?> WIB
            </span>
        </div>
        <i class="fas fa-tshirt wb-icon"></i>
    </div>

    
    <p class="sec-label">Ringkasan Hari Ini</p>
    <div class="row g-3 mb-4">
        <div class="col-6 col-lg-3">
            <a href="<?php echo e(route('apparel.orders.index')); ?>" class="stat-card blue d-flex">
                <div class="stat-icon"><i class="fas fa-shopping-cart"></i></div>
                <div class="stat-info">
                    <div class="stat-number"><?php echo e($stats['orders_today'] ?? 0); ?></div>
        ...
        <div class="col-6 col-lg-3">
            <a href="<?php echo e(route('apparel.orders.index', ['status' => 'menunggu'])); ?>" class="stat-card amber d-flex">
                <div class="stat-icon"><i class="fas fa-clock"></i></div>
                <div class="stat-info">
                    <div class="stat-number"><?php echo e($stats['orders_waiting'] ?? 0); ?></div>
                    <div class="stat-label">Menunggu Konfirmasi</div>
                    <div class="stat-link">Proses <i class="fas fa-arrow-right"></i></div>
                </div>
            </a>
        </div>
        <div class="col-6 col-lg-3">
            <a href="<?php echo e(route('apparel.orders.index', ['status' => 'disetujui'])); ?>" class="stat-card green d-flex">
                <div class="stat-icon"><i class="fas fa-check-circle"></i></div>
                <div class="stat-info">
                    <div class="stat-number"><?php echo e($stats['orders_approved'] ?? 0); ?></div>
        ...
        <div class="col-6 col-lg-3">
            <a href="<?php echo e(route('apparel.orders.index', ['status' => 'ditolak'])); ?>" class="stat-card red d-flex">
                <div class="stat-icon"><i class="fas fa-times-circle"></i></div>
                <div class="stat-info">
                    <div class="stat-number"><?php echo e($stats['orders_rejected'] ?? 0); ?></div>
            ...
            <div class="dash-card">
                <div class="dash-card-header">
                    <div class="dash-card-title">
                        <i class="fas fa-shopping-cart"></i> Order Terbaru
                    </div>
                    <a href="<?php echo e(route('apparel.orders.index')); ?>" class="dash-card-link">
                ...
                <table class="dash-table">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $recentOrders ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td style="font-weight: 700; color: #94A3B8; font-size: 0.78rem;">#<?php echo e($order->id); ?></td>
                                <td>
                                    <div style="font-weight: 700; font-size: 0.85rem;"><?php echo e($order->pemesan_name); ?></div>
                                </td>
                                <td>
                                    <div style="font-size: 0.85rem;"><?php echo e($order->product->name ?? 'N/A'); ?></div>
                                </td>
                                <td>
                                    <span style="font-weight: 700; font-size: 0.85rem;"><?php echo e($order->qty); ?></span>
                                    <span class="td-muted">pcs</span>
                                </td>
                                <td>
                                    <?php
                                ...
                                <td>
                                    <div class="td-muted">
                                        <i class="far fa-calendar-alt me-1"></i><?php echo e($order->created_at->format('d M Y')); ?>

                                    </div>
                                </td>
                                <td>
                                    <a href="<?php echo e(route('apparel.orders.show', $order)); ?>"
                                       class="btn-xs-act view" title="Lihat Detail">
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr class="empty-row">
                                <td colspan="7">
                                    <i class="fas fa-shopping-cart empty-icon-sm"></i>
    ...
    <div class="qa-grid mb-4">
        <a href="<?php echo e(route('apparel.categories.index')); ?>" class="qa-btn qa-blue">
            <div class="qa-icon"><i class="fas fa-tags"></i></div>
            <span>Kelola Kategori</span>
        </a>
        <a href="<?php echo e(route('apparel.products.index')); ?>" class="qa-btn qa-green">
            <div class="qa-icon"><i class="fas fa-box"></i></div>
            <span>Kelola Produk</span>
        </a>
        <a href="<?php echo e(route('apparel.orders.index')); ?>" class="qa-btn qa-amber">
            <div class="qa-icon"><i class="fas fa-shopping-cart"></i></div>
            <span>Kelola Order</span>
        </a>
        <a href="<?php echo e(route('service.apparel')); ?>" target="_blank" class="qa-btn qa-slate">
            <div class="qa-icon"><i class="fas fa-eye"></i></div>
            <span>Lihat Halaman Apparel</span>
        </a>
    </div>

    
    <p class="sec-label">Statistik Keseluruhan</p>
    <div class="sysinfo-grid">
        <div class="sysinfo-item">
            ...
            <div>
                <div class="si-label">Total Order</div>
                <div class="si-value"><?php echo e($stats['total_orders'] ?? 0); ?></div>
            </div>
        </div>
        <div class="sysinfo-item">
            ...
            <div>
                <div class="si-label">Total Produk</div>
                <div class="si-value"><?php echo e($stats['total_products'] ?? 0); ?></div>
            </div>
        </div>
        <div class="sysinfo-item">
            ...
            <div>
                ...
                <div class="si-value"><?php echo e($stats['total_categories'] ?? 0); ?></div>
            </div>
        </div>
        <div class="sysinfo-item">
            ...
            <div>
                ...
                <div class="si-value" id="liveTime"><?php echo e(now()->format('H:i:s')); ?></div>
            </div>
        </div>
    </div>
