...
<?php $__env->startSection('title', 'Informasi - QofMedia'); ?>
...
<section class="info-content">
    <div class="container">
        ...
        <div class="filter-card">
            <form method="GET" action="<?php echo e(route('information.index')); ?>">
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-md-4 col-lg-6">
                        <div class="d-flex gap-2">
                            ...
                            <a href="<?php echo e(route('information.index')); ?>" class="btn-reset">
                    ...
                    <div class="news-card h-100">
                        ...
                        <div class="card-body p-3">
                            <div class="news-category">
                                <i class="bi bi-tag me-1"></i> <?php echo e($article->category); ?>

                            </div>
                            <a href="<?php echo e(route('information.show', $article->slug)); ?>" class="text-decoration-none">
                                <h5 class="news-title"><?php echo e($article->title); ?></h5>
                            </a>
                            ...
                            <a href="<?php echo e(route('information.show', $article->slug)); ?>" class="news-link">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\qofmedia-web\resources\views/public/information/index.blade.php ENDPATH**/ ?>