...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="text-center mt-4">
                    <p style="color: #64748B; font-size: 0.82rem; margin-bottom: 0;">
                        Sudah punya akun?
                        <a href="<?php echo e(route('login')); ?>" class="text-link">Login di Sini</a>
                    </p>
                </div>
                ...
                <div class="text-center">
                    <a href="<?php echo e(route('home')); ?>" style="color: #64748B; text-decoration: none; font-size: 0.78rem; font-weight: 500; transition: all 0.3s;">
...
</html><?php /**PATH C:\xampp\htdocs\qofmedia-web\resources\views/auth/register.blade.php ENDPATH**/ ?>