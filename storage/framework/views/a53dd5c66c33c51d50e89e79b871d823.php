...
<?php $__env->startSection('title', 'Kelola Varian'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $variants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td><?php echo e($v->model->name ?? 'N/A'); ?></td>
                            <td><span class="badge badge-primary"><?php echo e($v->size); ?></span></td>
                            <td><?php echo e($v->color); ?></td>
                            <td><?php echo e($v->sleeve_type == 'pendek' ? 'Pendek' : 'Panjang'); ?></td>
                            <td><?php echo e($v->stock); ?></td>
                            <td>Rp <?php echo e(number_format($v->price, 0, ',', '.')); ?></td>
                            <td>
                                ...
                                <form action="<?php echo e(route('apparel.variants.destroy', $v)); ?>" method="POST" class="d-inline">
        ...
        <?php if($variants->hasPages()): ?>
            <div class="card-footer"><?php echo e($variants->links()); ?></div>
        <?php endif; ?>
    </div>
