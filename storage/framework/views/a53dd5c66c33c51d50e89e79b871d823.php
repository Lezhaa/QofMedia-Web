...
<?php $__env->startSection('title', 'Kelola Varian Kaos'); ?>
    ...
    <div class="row g-3 mb-4 anim-1">
        <div class="col-6 col-lg" style="min-width:0;">
            <div class="stat-card blue">
                ...
                <div>
                    <div class="stat-number"><?php echo e($variants->total()); ?></div>
        ...
        <div class="col-6 col-lg" style="min-width:0;">
            <div class="stat-card green">
                ...
                <div>
                    <div class="stat-number"><?php echo e($variants->sum('stock')); ?></div>
        ...
        <div class="col-6 col-lg" style="min-width:0;">
            <div class="stat-card amber">
                ...
                <div>
                    <div class="stat-number"><?php echo e($variants->where('stock', '<=', 5)->count()); ?></div>
        ...
        <div class="col-6 col-lg" style="min-width:0;">
            <div class="stat-card red">
                ...
                <div>
                    <div class="stat-number"><?php echo e($variants->where('stock', 0)->count()); ?></div>
    ...
    <div class="dash-card anim-2">
        ...
        <div class="dash-card-header">
            ...
            <span class="count-badge">
                ...
                <?php echo e($variants->total()); ?> varian
            </span>
        </div>
        ...
        <div class="filter-bar">
            ...
            <select class="filter-select" id="filterSize">
                ...
                <?php $__currentLoopData = ['S','M','L','XL','XXL']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <table class="dash-table" id="variantsTable">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $variants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        ?>
                        <tr data-name="<?php echo e(strtolower($v->color . ' ' . ($v->model->name ?? ''))); ?>"
                            data-size="<?php echo e($v->size); ?>"
                            data-sleeve="<?php echo e($v->sleeve_type); ?>"
                            data-stock="<?php echo e($stock); ?>">
                            <td><span class="row-num"><?php echo e($loop->iteration); ?></span></td>
                            <td>
                                <div style="font-weight:700; font-size:0.86rem;"><?php echo e($v->model->name ?? 'N/A'); ?></div>
                                <div class="td-muted">ID #<?php echo e($v->id); ?></div>
                            </td>
                            <td><span class="size-badge"><?php echo e($v->size); ?></span></td>
                            <td>
                                <div class="color-swatch">
                                    <span class="color-dot" style="background:<?php echo e($dotColor); ?>;"></span>
                                    <span style="font-weight:600;"><?php echo e($v->color); ?></span>
                                </div>
                            </td>
                            <td>
                                <span class="sleeve-pill <?php echo e($v->sleeve_type); ?>">
                                    <i class="fas fa-tshirt" style="font-size:0.7rem;"></i>
                                    <?php echo e($v->sleeve_type == 'pendek' ? 'Pendek' : 'Panjang'); ?>

                                </span>
                            </td>
                            <td>
                                <div class="stock-wrap">
                                    <span class="stock-val" style="color:<?php echo e($stockColor); ?>;"><?php echo e($stock); ?></span>
                                    <div class="stock-bar-bg">
                                        <div class="stock-bar-fill"
                                             style="width:<?php echo e($stockPct); ?>%; background:<?php echo e($stockColor); ?>;"></div>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <span class="price-val">Rp <?php echo e(number_format($v->price, 0, ',', '.')); ?></span>
                            </td>
                            <td style="text-align:center; white-space:nowrap;">
                                <button class="btn-xs-act edit edit-btn"
                                        title="Edit"
                                        data-id="<?php echo e($v->id); ?>"
                                        data-model="<?php echo e($v->model_id); ?>"
                                        data-size="<?php echo e($v->size); ?>"
                                ...
                                <form action="<?php echo e(route('apparel.variants.destroy', $v)); ?>"
    ...
    <div class="modal fade" id="addModal" tabindex="-1">
        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <form action="<?php echo e(route('apparel.variants.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="cfg-group">
                                        ...
                                        <select id="bulkModel" class="form-control">
                                            ...
                                            <?php $__currentLoopData = $models; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($m->id); ?>"><?php echo e($m->name); ?> (<?php echo e($m->edition->name ?? ''); ?>)</option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\qofmedia-web\resources\views/apparel/variants/index.blade.php ENDPATH**/ ?>