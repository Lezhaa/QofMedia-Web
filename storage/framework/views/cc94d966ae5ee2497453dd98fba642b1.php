...
<?php $__env->startSection('title', 'Detail Pemesanan Sewa'); ?>
    ...
    <div class="d-flex justify-content-between align-items-center">
        <div>
            ...
            <ol class="breadcrumb mb-0 mt-1" style="font-size: 0.8rem; background: transparent; padding: 0;">
                ...
                <li class="breadcrumb-item"><a href="<?php echo e(route('studio.rental-bookings.index')); ?>">Pemesanan Sewa</a></li>
                <li class="breadcrumb-item active">#<?php echo e($rentalBooking->id); ?></li>
            </ol>
        </div>
        <a href="<?php echo e(route('studio.rental-bookings.index')); ?>"
        ...
        <div class="col-lg-8">
            ...
            <div class="detail-card">
                <div class="detail-card-header">
                    ...
                    <div>
                        ...
                        <p class="detail-card-header-subtitle">Pemesanan #<?php echo e($rentalBooking->id); ?> · <?php echo e($rentalBooking->created_at->format('d M Y, H:i')); ?></p>
                    </div>
                    <div class="ml-auto">
                        <span class="status-badge status-<?php echo e($rentalBooking->status); ?>">
                ...
                <div class="detail-card-body">
                    ...
                    <div class="info-grid" style="margin-bottom: 20px;">
                        <div class="info-item">
                            ...
                            <div class="info-value"><?php echo e($rentalBooking->pemesan_name); ?></div>
                        </div>
                        <div class="info-item">
                            <div class="info-label"><i class="fas fa-phone"></i> Nomor HP</div>
                            <div class="info-value">
                                <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $rentalBooking->pemesan_phone)); ?>"
                                   target="_blank" style="color:#059669; text-decoration:none;">
                                    <i class="fab fa-whatsapp"></i> <?php echo e($rentalBooking->pemesan_phone); ?>
                    ...
                    <div class="tool-mini-card" style="margin-bottom: 20px;">
                        <?php if($rentalBooking->tool?->image): ?>
                            <img src="<?php echo e(asset('storage/' . $rentalBooking->tool->image)); ?>" class="tool-mini-img" alt="">
                        <?php else: ?>
                            <div class="tool-mini-placeholder"><i class="fas fa-tools"></i></div>
                        <?php endif; ?>
                        <div>
                            <div class="tool-mini-name"><?php echo e($rentalBooking->tool->name ?? '—'); ?></div>
                            <div class="tool-mini-price">
                                Kategori: <?php echo e($rentalBooking->tool->category ?? '—'); ?>

                                &nbsp;·&nbsp;
                                Rp <?php echo e(number_format($rentalBooking->tool->price_per_day ?? 0, 0, ',', '.')); ?> / hari
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="info-grid">
                        <div class="info-item">
                            ...
                            <div class="info-value"><?php echo e($rentalBooking->tanggal_mulai->format('d M Y')); ?></div>
                        </div>
                        <div class="info-item">
                            <div class="info-label"><i class="fas fa-calendar-check"></i> Tanggal Selesai</div>
                            <div class="info-value"><?php echo e($rentalBooking->tanggal_selesai->format('d M Y')); ?></div>
                        </div>
                        <div class="info-item">
                            <div class="info-label"><i class="fas fa-clock"></i> Durasi</div>
                            <div class="info-value"><?php echo e($rentalBooking->durasi); ?> hari</div>
                        </div>
                        <div class="info-item">
                            <div class="info-label"><i class="fas fa-box"></i> Jumlah Unit</div>
                            <div class="info-value"><?php echo e($rentalBooking->qty); ?> unit</div>
                        </div>
                        <div class="info-item" style="grid-column: 1 / -1;">
                            <div class="info-label"><i class="fas fa-money-bill-wave"></i> Total Biaya</div>
                            <div class="info-value price">Rp <?php echo e(number_format($rentalBooking->total_harga, 0, ',', '.')); ?></div>
                        </div>
                    </div>
                    ...
                    <?php if($rentalBooking->catatan_user): ?>
                        ...
                        <div style="background:#F8FAFC; border:1px solid #E2E8F0; border-radius:10px; padding:12px 16px; font-size:0.88rem; color:#374151; line-height:1.6;">
                            <?php echo e($rentalBooking->catatan_user); ?>
            ...
            <div class="detail-card">
                ...
                <div class="detail-card-body">
                    ...
                    <?php if($rentalBooking->bukti_transfer): ?>
                        <a href="<?php echo e(asset('storage/' . $rentalBooking->bukti_transfer)); ?>" target="_blank">
                            <img src="<?php echo e(asset('storage/' . $rentalBooking->bukti_transfer)); ?>" class="bukti-img" alt="Bukti Transfer">
                        </a>
                        <div style="margin-top:8px; display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap; gap:8px;">
                            ...
                            <a href="<?php echo e(asset('storage/' . $rentalBooking->bukti_transfer)); ?>" download
                        ...
                        <?php if($rentalBooking->status === 'menunggu'): ?>
                            ...
                            <form action="<?php echo e(route('studio.rental-bookings.validate-proof', $rentalBooking)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <div class="row g-3">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <textarea name="catatan_admin" class="field-textarea-sm" rows="2"
                                                  placeholder="Nominal sesuai / rekening tidak cocok..."><?php echo e($rentalBooking->catatan_admin); ?></textarea>
                                    </div>
                                </div>
                    ...
                    <div style="margin-top: 20px;">
                        ...
                        <?php if($rentalBooking->jenis_jaminan): ?>
                            <span class="jaminan-badge"><i class="fas fa-id-badge"></i> <?php echo e($rentalBooking->jaminan_label); ?></span>
                        <?php else: ?>
            ...
            <?php if(!in_array($rentalBooking->status, ['selesai', 'ditolak'])): ?>
                <div class="detail-card">
                    <div class="detail-card-header">
                    ...
                    <div class="detail-card-body">
                        ...
                        <?php if($rentalBooking->status === 'menunggu'): ?>
                            ...
                            <?php elseif($proofStatus === 'pending'): ?>
                                <div style="background:#FEF9C3; border:1px solid #FDE68A; border-radius:10px; padding:12px 16px; font-size:0.85rem; color:#92400E; margin-bottom:16px; display:flex; align-items:center; gap:8px;">
                                    <i class="fas fa-exclamation-circle" style="color:#F59E0B; flex-shrink:0;"></i>
                        ...
                        <form action="<?php echo e(route('studio.rental-bookings.update-status', $rentalBooking)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            ...
                            <div>
                                ...
                                <textarea class="custom-textarea" id="catatan_admin" name="catatan_admin"
                                          rows="3"
                                          placeholder="Misal: Silakan ambil alat di studio pukul 08.00..."><?php echo e(old('catatan_admin', $rentalBooking->catatan_admin)); ?></textarea>
                            </div>

                            <div class="status-actions">
                                <?php if($rentalBooking->status === 'menunggu'): ?>
                                    
                                    <?php $canApprove = $proofStatus === 'valid'; ?>
                                    <button type="submit" name="status" value="disetujui"
                                            class="btn-action btn-setujui"
                                            <?php echo e(!$canApprove ? 'disabled' : ''); ?>

                                            title="<?php echo e(!$canApprove ? 'Validasi bukti transfer terlebih dahulu' : 'Setujui pemesanan'); ?>">
                                ...
                                <?php if($rentalBooking->status === 'disetujui'): ?>
                                ...
                                <?php if($rentalBooking->status === 'aktif'): ?>
                    ...
                    <?php if($rentalBooking->status === 'ditolak'): ?>
                        <div style="display:flex; align-items:center; gap:10px; padding:12px 14px; background:#FEF2F2; border:1px solid rgba(220,38,38,0.15); border-radius:10px;">
                            ...
                            <div>
                                ...
                                <div style="font-size:0.75rem; color:#94A3B8;"><?php echo e($rentalBooking->updated_at->format('d M Y')); ?></div>
                            </div>
                        </div>
                    <?php else: ?>
                        <ul class="timeline">
                            <?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                ?>
                                <li class="tl-item">
                                    <div class="tl-dot <?php echo e($state); ?>">
                                        <i class="fas <?php echo e($state === 'done' ? 'fa-check' : $step['icon']); ?>" style="font-size:0.7rem;"></i>
                                    </div>
                                    <div class="tl-content">
                                        <div class="tl-title" style="<?php echo e($state === 'pending' ? 'color:#94A3B8;' : ''); ?>"><?php echo e($step['label']); ?></div>
                                        <div class="tl-sub"><?php echo e($step['sub']); ?></div>
                                    </div>
                                </li>
                    ...
                    <div style="display:flex; flex-direction:column; gap:12px;">
                        <?php $__currentLoopData = [
                            ...
                            <div style="display:flex; justify-content:space-between; align-items:center; padding-bottom:12px; border-bottom:1px solid #F8FAFC;">
                                <span style="font-size:0.78rem; color:#94A3B8;"><?php echo e($row['label']); ?></span>
                                <span style="font-size:0.83rem; font-weight:700; color:#0D1B2A;"><?php echo e($row['value']); ?></span>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\qofmedia-web\resources\views/studio/rental-bookings/show.blade.php ENDPATH**/ ?>