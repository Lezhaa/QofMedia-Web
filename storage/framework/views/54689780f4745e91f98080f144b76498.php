...
<div class="modal fade" id="orderModal" tabindex="-1">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 rounded-4">
            <form action="<?php echo e(route('order.store')); ?>" method="POST" enctype="multipart/form-data" id="orderForm">
                <?php echo csrf_field(); ?>
                ...
                <div class="modal-body px-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="hidden" id="hiddenTotal" name="total_price" value="<?php echo e($product->price); ?>">
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        <div style="background:#FEF9EC; border:1px solid #FDE68A; border-radius:12px; padding:12px 16px; margin-bottom:14px; font-size:0.82rem; color:#78350F;">
                            ...
                            Nominal: <strong id="transferAmount">Rp <?php echo e(number_format($product->price, 0, ',', '.')); ?></strong><br>
