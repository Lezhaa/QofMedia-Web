...
<?php $__env->startSection('content_header'); ?>
    <div class="d-flex justify-content-between align-items-center">
        ...
        <a href="<?php echo e(route('studio.packages.create')); ?>"
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="stats-bar">
        <div class="stat-chip">
            ...
            Total Paket: <strong><?php echo e($packages->total()); ?></strong>
        </div>
        <div class="stat-chip">
            <i class="fas fa-tags"></i>
            Tipe Unik: <strong><?php echo e($packages->pluck('type')->unique()->count()); ?></strong>
        </div>
    </div>
    ...
    <div class="filter-bar">
        ...
        <select id="typeFilter" onchange="filterRows()">
            ...
            <?php $__currentLoopData = $packages->pluck('type')->unique()->sort(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="pkg-row"
                                ...
                                data-type="<?php echo e(strtolower($package->type)); ?>">

                                
                                <td style="color:#CBD5E1; font-size:0.8rem; font-weight:600;">
                                    <?php echo e($packages->firstItem() + $index); ?>
                                ...
                                <td style="max-width: 240px;">
                                    ...
                                    <?php if($package->description): ?>
                                        <div class="pkg-desc"><?php echo e($package->description); ?></div>
                                    <?php endif; ?>
                                </td>

                                
                                <td>
                                    <span class="badge-type"><?php echo e($package->type); ?></span>
                                </td>
                                    ...
                                    <?php if(is_array($package->facilities) && count($package->facilities) > 0): ?>
                                        <ul class="facility-list">
                                            ...
                                            <?php if(count($package->facilities) > 3): ?>
                                                <li class="more">
                                                    +<?php echo e(count($package->facilities) - 3); ?> lainnya
                                                </li>
                                            <?php endif; ?>
                                        </ul>
                                    <?php else: ?>
                                ...
                                <td>
                                    <div style="display:flex; align-items:center; justify-content:center; gap:6px;">
                                        <a href="<?php echo e(route('studio.packages.edit', $package)); ?>"
                                           class="act-btn edit" title="Edit">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <form action="<?php echo e(route('studio.packages.destroy', $package)); ?>"
