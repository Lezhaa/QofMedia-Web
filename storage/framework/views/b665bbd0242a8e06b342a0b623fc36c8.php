...
unset($__errorArgs, $__bag); ?>" 
                           ...
                           placeholder="Contoh: Berita, Pengumuman, Tips" required>
...
unset($__errorArgs, $__bag); ?>" 
                              id="excerpt" name="excerpt" rows="2"><?php echo e(old('excerpt')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                              id="content" name="content" rows="10" required><?php echo e(old('content')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                           id="published_at" name="published_at" value="<?php echo e(old('published_at', now()->format('Y-m-d\TH:i'))); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\qofmedia-web\resources\views/admin/articles/create.blade.php ENDPATH**/ ?>