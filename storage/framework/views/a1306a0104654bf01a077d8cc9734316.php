        ...
        <div class="row">
            <div class="col-lg-8">
                        ...
                        <?php $__currentLoopData = $timeline; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="timeline-item">
                                <div class="timeline-dot 
                                    <?php if(isset($item['completed']) && $item['completed']): ?> completed
                                    <?php elseif(isset($item['active']) && $item['active']): ?> active
                                    <?php elseif(isset($item['isRejected']) && $item['isRejected']): ?> rejected
                                    <?php endif; ?>">
                                </div>
                                <div class="timeline-content">
                                    <div class="timeline-title">
                                        ...
                                        <?php if(isset($item['isValid']) && $item['isValid'] === false): ?>
                                    ...
                                    <?php if(isset($item['date']) && $item['date']): ?>
                                        <div class="timeline-date">
                                            ...
                                            <?php echo e(\Carbon\Carbon::parse($item['date'])->format('d M Y, H:i')); ?> WIB
                                        </div>
                                    <?php endif; ?>
                                    <?php if(isset($item['description'])): ?>
                                        <div class="timeline-desc <?php echo e(isset($item['isRejected']) && $item['isRejected'] ? 'reason' : ''); ?>">
                                            <?php echo e($item['description']); ?>

                                        </div>
                                    <?php endif; ?>
                                    <?php if(isset($item['tracking']) && $item['tracking']): ?>
                                        <div class="tracking-note">
                                            <i class="bi bi-upc-scan"></i>
                                            <div>
                                                <div class="tn-label">Nomor Resi</div>
                                                <div class="tn-code"><?php echo e($item['tracking']); ?></div>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                </div>
                    ...
                    <?php if($order->tracking_number): ?>
                        <div class="tracking-note" style="margin-top:12px; margin-bottom:0;">
                            ...
                            <div>
                                ...
                                <div class="tn-code"><?php echo e($order->tracking_number); ?></div>
                            </div>
                        </div>
                    <?php endif; ?>
                    <form action="<?php echo e(route('user.orders.diterima', $order)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="product-img-wrap">
                            <?php if($imgPath): ?>
                                <img src="<?php echo e(asset('storage/' . $imgPath)); ?>"
                                     alt="<?php echo e($product->name ?? 'Produk'); ?>"
                        ...
                        <div class="product-info">
                            ...
                            <?php if($variant): ?>
                                <div class="product-variant-chips">
                                    <?php if($variant->size): ?>
                                        <span class="variant-chip"><i class="bi bi-rulers"></i> <?php echo e($variant->size); ?></span>
                                    <?php endif; ?>
                                    <?php if($variant->color): ?>
                                        <span class="variant-chip"><i class="bi bi-palette"></i> <?php echo e($variant->color); ?></span>
                                    <?php endif; ?>
                                    <?php if($variant->sleeve_type): ?>
                                        <span class="variant-chip"><i class="bi bi-person-standing"></i> <?php echo e($variant->sleeve_type); ?></span>
                                    <?php endif; ?>
                                </div>
                            <?php endif; ?>
                            ...
                            <div class="product-price-row">
                                <div class="product-price-unit">
                                    Harga satuan: <strong>Rp <?php echo e(number_format($price, 0, ',', '.')); ?></strong>
                                </div>
                                <div class="product-qty-badge">
                                    <i class="bi bi-layers"></i> × <?php echo e($order->qty); ?>
                            ...
                            <div class="product-total">
                                ...
                                <strong style="color:#0E7A96;">Rp <?php echo e(number_format($total, 0, ',', '.')); ?></strong>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="detail-card">
                    ...
                    <div class="info-row"><span class="info-label">Nama Pemesan</span><span class="info-value">: <?php echo e($order->pemesan_name); ?></span></div>
                    <div class="info-row"><span class="info-label">Nomor HP/WA</span><span class="info-value">: <?php echo e($order->pemesan_phone); ?></span></div>
                    <div class="info-row"><span class="info-label">Alamat</span><span class="info-value">: <?php echo e($order->alamat); ?></span></div>
                    <div class="info-row"><span class="info-label">Produk</span><span class="info-value">: <?php echo e($order->product->name ?? '-'); ?></span></div>
                    <div class="info-row">
                        <span class="info-label">Metode Pembayaran</span>
                        <span class="info-value">: <?php echo e($order->payment_method == 'manual_transfer' ? 'Transfer Manual' : 'Payment Gateway'); ?></span>
                    </div>
                    ...
                    <?php if($order->payment_method == 'manual_transfer'): ?>
                        <div class="info-row">
                            ...
                            <span class="info-value">: 
                                <?php if($order->payment_proof): ?>
                                    <a href="<?php echo e(asset('storage/' . $order->payment_proof)); ?>" target="_blank" class="btn btn-sm btn-info">
                                        <i class="bi bi-image"></i> Lihat Bukti
                                    </a>
                                    <?php $proofStatus = $order->payment_proof_validated ?? 'pending'; ?>
                                    <span class="proof-badge <?php echo e($proofStatus); ?> ms-2">
                                        <?php if($proofStatus == 'valid'): ?> <i class="bi bi-check-circle"></i> Valid
                                        <?php elseif($proofStatus == 'invalid'): ?> <i class="bi bi-x-circle"></i> Tidak Valid
                                        <?php else: ?> <i class="bi bi-clock"></i> Pending
                                        <?php endif; ?>
                                    </span>
                                <?php else: ?>
                        ...
                        <div class="info-row">
                            ...
                            <span class="info-value">: <?php echo e($order->payment_message ?? '-'); ?></span>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if($order->variant): ?>
                        <div class="info-row">
                            ...
                            <span class="info-value">: <?php echo e($order->variant->size); ?> / <?php echo e($order->variant->color); ?> / <?php echo e($order->variant->sleeve_type); ?></span>
                        </div>
                    <?php endif; ?>
                    <div class="info-row"><span class="info-label">Jumlah</span><span class="info-value">: <?php echo e($order->qty); ?></span></div>
                    <div class="info-row">
                        <span class="info-label">Total Harga</span>
                        <span class="info-value">
                            <?php $price = $order->variant->price ?? $order->product->price ?? 0; ?>
                            : <strong style="color:#0E7A96;">Rp <?php echo e(number_format($price * $order->qty, 0, ',', '.')); ?></strong>
                        </span>
                    </div>
                    <?php if($order->catatan_user): ?>
                        <div class="info-row"><span class="info-label">Catatan</span><span class="info-value">: <?php echo e($order->catatan_user); ?></span></div>
                    <?php endif; ?>
                    <div class="info-row"><span class="info-label">Tanggal Pesan</span><span class="info-value">: <?php echo e($order->created_at->format('d M Y H:i')); ?></span></div>
                </div>
            </div>
            ...
            <div class="col-lg-4">
                <div class="detail-card">
                    ...
                    <span class="status-badge <?php echo e($order->status); ?>">
                        <?php if($order->status == 'menunggu'): ?>     Menunggu Konfirmasi
                        <?php elseif($order->status == 'disetujui'): ?> Disetujui
                        <?php elseif($order->status == 'packing'): ?>  Sedang Dipacking
                        <?php elseif($order->status == 'dikirim'): ?>  Dalam Pengiriman
                        <?php elseif($order->status == 'diterima'): ?> Pesanan Diterima
                        <?php elseif($order->status == 'ditolak'): ?>  Ditolak
                    ...
                    <?php if($order->catatan_admin): ?>
                        <div class="admin-note">
                            ...
                            <p><?php echo e($order->catatan_admin); ?></p>
                        </div>
                    <?php endif; ?>
                    <hr>
                    <a href="<?php echo e(route('user.orders')); ?>" class="btn-back">
                ...
                <div class="detail-card">
                    ...
                    <a href="<?php echo e(route('contact')); ?>" class="btn-contact">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\qofmedia-web\resources\views/user/orders/show.blade.php ENDPATH**/ ?>