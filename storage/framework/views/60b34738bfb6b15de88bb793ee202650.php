...
<?php $__env->startSection('title', 'Profil QofMedia'); ?>
    ...
    <div class="container">
        <div class="about-grid">
            ...
            <div class="about-image-wrapper">
                ...
                ?>
                <?php if($hasPhoto): ?>
                    <img src="<?php echo e(asset($aboutPhoto)); ?>" alt="Tim QofMedia" class="main-img">
                <?php else: ?>
    ...
    <div class="container">
        <div class="cta-card">
            ...
            <div class="btn-group">
                ...
                <a href="<?php echo e(route('service.studio')); ?>" class="btn-cta-outline">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\qofmedia-web\resources\views/public/about/profile.blade.php ENDPATH**/ ?>