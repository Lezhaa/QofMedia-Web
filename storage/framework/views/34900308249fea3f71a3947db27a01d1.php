...
<?php $__env->startSection('content'); ?>
    ...
    <div class="welcome-banner">
        <div class="wb-content">
            ...
            <p>Kelola peralatan, paket studio, dan paket fotografi &mdash; <?php echo e(now()->isoFormat('dddd, D MMMM Y')); ?></p>
            <span class="wb-time">
    ...
    <div class="row g-3 mb-4">
        <div class="col-6 col-lg-3">
            <a href="<?php echo e(route('studio.tools.index')); ?>" class="stat-card blue d-flex">
                <div class="stat-icon"><i class="fas fa-tools"></i></div>
                <div class="stat-info">
                    <div class="stat-number"><?php echo e($stats['total_tools'] ?? 0); ?></div>
        ...
        <div class="col-6 col-lg-3">
            <a href="<?php echo e(route('studio.tools.index')); ?>" class="stat-card green d-flex">
                <div class="stat-icon"><i class="fas fa-check-circle"></i></div>
                <div class="stat-info">
                    <div class="stat-number"><?php echo e($stats['available_tools'] ?? 0); ?></div>
        ...
        <div class="col-6 col-lg-3">
            <a href="<?php echo e(route('studio.packages.index')); ?>" class="stat-card amber d-flex">
                <div class="stat-icon"><i class="fas fa-video"></i></div>
                <div class="stat-info">
                    <div class="stat-number"><?php echo e($stats['total_studio_packages'] ?? 0); ?></div>
        ...
        <div class="col-6 col-lg-3">
            <a href="<?php echo e(route('studio.photo-packages.index')); ?>" class="stat-card red d-flex">
                <div class="stat-icon"><i class="fas fa-camera"></i></div>
                <div class="stat-info">
                    <div class="stat-number"><?php echo e($stats['total_photo_packages'] ?? 0); ?></div>
    ...
    <div class="qa-grid mb-4">
        <a href="<?php echo e(route('studio.tools.create')); ?>" class="qa-btn qa-blue">
            <div class="qa-icon"><i class="fas fa-plus-circle"></i></div>
            <span>Tambah Alat Baru</span>
        </a>
        <a href="<?php echo e(route('studio.packages.create')); ?>" class="qa-btn qa-green">
            <div class="qa-icon"><i class="fas fa-video"></i></div>
            <span>Tambah Paket Studio</span>
        </a>
        <a href="<?php echo e(route('studio.photo-packages.create')); ?>" class="qa-btn qa-amber">
            <div class="qa-icon"><i class="fas fa-camera"></i></div>
            <span>Tambah Paket Foto</span>
        </a>
        <a href="<?php echo e(route('service.studio')); ?>" target="_blank" class="qa-btn qa-rose">
        ...
        <div class="col-lg-7">
            <div class="dash-card">
                ...
                <div class="dash-card-body">
                    <a href="<?php echo e(route('studio.tools.index')); ?>" class="qa-row teal">
                    ...
                    <a href="<?php echo e(route('studio.packages.index')); ?>" class="qa-row green">
                    ...
                    <a href="<?php echo e(route('studio.photo-packages.index')); ?>" class="qa-row amber">
                    ...
                    <a href="<?php echo e(route('service.studio')); ?>" target="_blank" class="qa-row blue">
                ...
                <div class="dash-card-body">
                    <div class="info-panel">
                        ...
                        <div class="wa-row">
                            ...
                            WhatsApp Studio:
                            <strong><?php echo e(setting('whatsapp_studio', '6281246943349')); ?></strong>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="sysinfo-grid">
        <div class="sysinfo-item">
            ...
            <div>
                ...
                <div class="si-value">v<?php echo e(app()->version()); ?></div>
            </div>
        </div>
        <div class="sysinfo-item">
            ...
            <div>
                ...
                <div class="si-value"><?php echo e($stats['total_tools'] ?? 0); ?></div>
            </div>
        </div>
        <div class="sysinfo-item">
            ...
            <div>
                ...
                <div class="si-value"><?php echo e(($stats['total_studio_packages'] ?? 0) + ($stats['total_photo_packages'] ?? 0)); ?></div>
            </div>
        </div>
        <div class="sysinfo-item">
