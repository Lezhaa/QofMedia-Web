...
<?php $__env->startSection('content'); ?>
    ...
    <div class="order-banner anim-1">
        <div class="ob-content">
            ...
            <p><?php echo e($order->pemesan_name); ?> &bull; <?php echo e($order->product->name ?? 'N/A'); ?></p>
            <div class="ob-meta">
                <span class="ob-chip">
                    <i class="fas fa-calendar-alt"></i>
                    <?php echo e($order->created_at->format('d M Y, H:i')); ?> WIB
                </span>
                <?php
                ...
                ?>
                <span class="ob-chip ob-chip-status <?php echo e($statusClass); ?>">
        ...
        <div class="ob-total">
            ...
            <div class="ob-total-amount">
                Rp <?php echo e(number_format($order->qty * ($order->variant->price ?? $order->product->price ?? 0), 0, ',', '.')); ?>

            </div>
            <div class="ob-total-sub"><?php echo e($order->qty); ?> pcs &times; Rp <?php echo e(number_format($order->variant->price ?? $order->product->price ?? 0, 0, ',', '.')); ?></div>
        </div>
    </div>
            ...
            <div class="dash-card anim-2" style="margin-bottom: 20px;">
                <div class="dash-card-header">
                    ...
                    <span style="font-size:0.75rem; color:#94A3B8; font-weight:600;">
                        <i class="fas fa-hashtag me-1"></i><?php echo e($order->id); ?>
                ...
                <table class="info-table">
                    <tr>
                        ...
                        <td>
                            <strong style="font-size:0.95rem;"><?php echo e($order->pemesan_name); ?></strong>
                        </td>
                    </tr>
                    <tr>
                        <th>
                    ...
                    <tr>
                        ...
                        <td style="line-height: 1.6;"><?php echo e($order->alamat); ?></td>
                    </tr>
                    <tr>
                        <th>
                            <span class="td-icon" style="background:#EEF9FC; color:#0E7A96; display:inline-flex;">
                        ...
                        <td>
                            <strong><?php echo e($order->product->name ?? 'N/A'); ?></strong>
                        </td>
                    </tr>
                        ...
                        <td>
                            <div class="variant-grid">
                                <span class="variant-chip">
                                    ...
                                    <?php echo e($order->variant->size); ?>

                                </span>
                                <span class="variant-chip">
                                    <span class="vc-label">Warna</span>
                                    <?php echo e($order->variant->color); ?>

                                </span>
                                <span class="variant-chip">
                                    <span class="vc-label">Lengan</span>
                                    <?php echo e($order->variant->sleeve_type); ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <span style="font-size:1.1rem; font-weight:800; color:#0D1B2A;"><?php echo e($order->qty); ?></span>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <span style="display:block; font-size:0.75rem; color:#94A3B8; margin-top:2px;">
                                <?php echo e($order->qty); ?> pcs &times;
                                Rp <?php echo e(number_format($order->variant->price ?? $order->product->price ?? 0, 0, ',', '.')); ?>
                    ...
                    <div class="tl-item">
                        ...
                        <div class="tl-body">
                            ...
                            <div class="tl-time">
                                ...
                                <?php echo e($order->created_at->format('d M Y, H:i')); ?> WIB &bull;
                    ...
                    <?php if($order->status == 'disetujui'): ?>
                        <div class="tl-item">
                            ...
                            <div class="tl-body">
                                ...
                                <div class="tl-time">
                                    <i class="far fa-clock me-1"></i>
                                    <?php echo e($order->updated_at->format('d M Y, H:i')); ?> WIB
                                </div>
                                <?php if($order->catatan_admin): ?>
                    ...
                    <?php elseif($order->status == 'ditolak'): ?>
                        <div class="tl-item">
                            ...
                            <div class="tl-body">
                                ...
                                <?php if($order->catatan_admin): ?>
                                    <div style="margin-top:6px; font-size:0.8rem; color:#64748B;">
                                        Alasan: <?php echo e($order->catatan_admin); ?>
                ...
                <div style="padding: 18px 22px;">
                    ...
                    <div class="user-info-item">
                        ...
                        <div>
                            ...
                            <div class="uii-value"><?php echo e($order->user->email ?? 'N/A'); ?></div>
                        </div>
                    </div>
                    <div class="user-info-item">
                        ...
                        <div>
                            ...
                            <div class="uii-value"><?php echo e($order->created_at->format('d M Y, H:i')); ?></div>
                        </div>
                    </div>
                    <div class="user-info-item">
                        ...
                        <div>
                            ...
                            <div class="uii-value"><?php echo e($order->updated_at->diffForHumans()); ?></div>
                        </div>
                    </div>
                </div>
            </div>
