...
namespace App\Models {
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Notification>|Notification forUser(int $userId) {@see App\Models\Notification::scopeForUser()}
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectExpression($expression, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Order>|Order wherePackingAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Order>|Order whereShippedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Order>|Order whereReceivedAt($value)
    ...
    /**
     * App\Models\RentalBooking
     *
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property string|null $catatan_admin
     * @property mixed $status
     * @property boolean $setuju_syarat
     * @property mixed $jenis_jaminan
     * @property mixed $bukti_transfer_validated
     ...
     * @property-read mixed $jaminan_label
     * @property-read mixed $status_label
     * @property-read mixed $status_badge_class
     * @property-read \App\Models\User $user
     * @property-read \App\Models\RentalTool $tool
     * @method static \Illuminate\Database\Eloquent\Builder<RentalBooking>|RentalBooking whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<RentalBooking>|RentalBooking whereUserId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<RentalBooking>|RentalBooking whereToolId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<RentalBooking>|RentalBooking wherePemesanName($value)
     * @method static \Illuminate\Database\Eloquent\Builder<RentalBooking>|RentalBooking wherePemesanPhone($value)
     * @method static \Illuminate\Database\Eloquent\Builder<RentalBooking>|RentalBooking whereTanggalMulai($value)
     * @method static \Illuminate\Database\Eloquent\Builder<RentalBooking>|RentalBooking whereTanggalSelesai($value)
     * @method static \Illuminate\Database\Eloquent\Builder<RentalBooking>|RentalBooking whereQty($value)
     * @method static \Illuminate\Database\Eloquent\Builder<RentalBooking>|RentalBooking whereTotalHarga($value)
     * @method static \Illuminate\Database\Eloquent\Builder<RentalBooking>|RentalBooking whereCatatanUser($value)
     * @method static \Illuminate\Database\Eloquent\Builder<RentalBooking>|RentalBooking whereBuktiTransfer($value)
     * @method static \Illuminate\Database\Eloquent\Builder<RentalBooking>|RentalBooking whereBuktiTransferValidated($value)
     * @method static \Illuminate\Database\Eloquent\Builder<RentalBooking>|RentalBooking whereJenisJaminan($value)
     * @method static \Illuminate\Database\Eloquent\Builder<RentalBooking>|RentalBooking whereSetujuSyarat($value)
     * @method static \Illuminate\Database\Eloquent\Builder<RentalBooking>|RentalBooking whereStatus($value)
     * @method static \Illuminate\Database\Eloquent\Builder<RentalBooking>|RentalBooking whereCatatanAdmin($value)
     * @method static \Illuminate\Database\Eloquent\Builder<RentalBooking>|RentalBooking whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<RentalBooking>|RentalBooking whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<RentalBooking>|RentalBooking newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<RentalBooking>|RentalBooking newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<RentalBooking>|RentalBooking query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectExpression($expression, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     ...
     * @method static mixed lockForUpdate()
     * @method static mixed sharedLock()
     * @method static \Illuminate\Database\Eloquent\Builder<RentalBooking>|RentalBooking timeout(int $seconds)
     * @method static mixed beforeQuery(callable $callback)
     * @method static mixed applyBeforeQueryCallbacks()
     * @method static mixed afterQuery(Closure $callback)
     * @method static mixed applyAfterQueryCallbacks($result)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class RentalBooking extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
