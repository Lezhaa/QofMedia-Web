            ...
            <div class="login-body">
                ...
                <div class="text-center mt-4">
                    <p style="color: #64748B; font-size: 0.9rem; margin-bottom: 0;">
                        Belum punya akun?
                        <a href="{{ route('register') }}" class="text-link">Daftar Sekarang</a>
                    </p>
                </div>
                ...
                <div class="text-center">
                    <a href="{{ route('home') }}" style="color: #64748B; text-decoration: none; font-size: 0.85rem; font-weight: 500; transition: all 0.3s;">
