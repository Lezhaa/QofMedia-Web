    ...
    <div class="d-flex justify-content-between align-items-center">
        <div>
            <h1 class="mb-0" style="font-size: 1.4rem; font-weight: 700; color: #0D1B2A;">
                <i class="fas fa-plus-circle me-2" style="color: #0E7A96;"></i> Tambah Album
            </h1>
...
<style>
    ...
    .file-upload-text  { font-size: 0.85rem; font-weight: 600; color: #0D1B2A; margin-bottom: 4px; }
    .file-upload-hint  { font-size: 0.72rem; color: #94A3B8; }
    .file-preview {
...
@section('content')
    ...
    <form action="{{ route('admin.albums.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row g-3 mb-2">
            ...
            {{-- Kolom Kiri — Nama, Tahun, Deskripsi --}}
            <div class="col-lg-8">
                <div class="form-card">
                    ...
                    <div class="form-card-body">
                        ...
                        <div>
                            ...
                            <textarea name="description"
                                      ...
                                      placeholder="Tuliskan deskripsi singkat album...">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-msg"><i class="fas fa-exclamation-circle"></i> {{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="form-card">
                    <div class="form-card-header">
                        ...
                        <div>
                            ...
                            <div class="form-card-header-sub">Foto sampul untuk album</div>
                        </div>
                    </div>
                    <div class="form-card-body">
                        <div class="file-upload-area" id="coverArea">
                            ...
                            <img id="coverPreview" class="file-preview" alt="Preview Cover">
                        </div>
                        @error('cover_image')
...
<script>
    document.getElementById('coverInput').addEventListener('change', function () {
        ...
        document.querySelector('#coverArea .file-upload-text').textContent = file.name;
        document.querySelector('#coverArea .file-upload-icon').style.display = 'none';
    });
</script>
@endpush