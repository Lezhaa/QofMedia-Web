...
<section class="gallery-year-hero">
    <div class="container">
        ...
        <h1>Tahun <span>{{ $year }}</span></h1>
        <p>{{ $albums->count() }} album tersedia</p>
    </div>
</section>
                        ...
                        <div class="album-card">
                            @if($album->cover_image)
                                <div class="album-card-img">
                                    <img src="{{ asset('storage/' . $album->cover_image) }}" alt="{{ $album->name }}" loading="lazy">
                                </div>
                            @else
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">{{ Str::limit($album->description, 60) }}</p>
                                <div class="album-meta">
                                    <span class="badge-item">{{ $album->items_count ?? 0 }} Item</span>
                                    <span class="text-date">{{ $album->created_at->format('d M Y') }}</span>
                                </div>
                            </div>
                        </div>
                    </a>
            ...
            @empty
                <div class="col-12">
                    <div class="text-center py-5">
                        ...
                        <p class="text-muted">Belum ada album untuk tahun {{ $year }}.</p>
                        <a href="{{ route('gallery.index') }}" class="btn-back mt-3">
