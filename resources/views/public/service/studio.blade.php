                    ...
                    @forelse($tools as $tool)
                        <div class="col-md-6 col-lg-4">
                            <div class="service-card h-100">
                                ...
                                <p class="text-muted small mb-2">{{ Str::limit($tool->description, 80) }}</p>

                                <div class="price-tag">
                                    Rp {{ number_format($tool->price_per_day, 0, ',', '.') }} <small>/ hari</small>
                                </div>
                                <p class="small text-muted mb-3">Stok: {{ $tool->stock }}</p>

                                @if($tool->is_available && $tool->stock > 0)
                                    <a href="https://wa.me/{{ $whatsappNumber ?? '6281246943349' }}?text={{ urlencode('Halo, saya tertarik menyewa ' . $tool->name) }}"
                    ...
                    @forelse($studioPackages as $package)
                        <div class="col-md-6">
                            <div class="service-card h-100 text-center">
                                ...
                                <p class="small text-muted mb-3">Durasi: {{ $package->duration }}</p>
                    ...
                    @forelse($photoPackages as $package)
                        <div class="col-md-6 col-lg-4">
                            <div class="service-card h-100 text-center">
                                ...
                                <h5 class="fw-bold">{{ $package->name }}</h5>
                                <div class="price-tag mb-1">Rp {{ number_format($package->price, 0, ',', '.') }}</div>
                                <p class="small text-muted mb-2">{{ $package->duration }}</p>
                                <p class="text-muted small mb-2">{{ $package->description }}</p>
