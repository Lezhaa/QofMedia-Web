...
<section class="division-section {{ $index % 2 !== 0 ? 'bg-alt' : '' }}"
         data-division="{{ $division->id }}">
    <div class="container">
        {{-- Section header — observed individually --}}
        ...
        @if($division->activeMembers->count() > 0)
            {{-- Unique, predictable ID — no '#' prefix here --}}
            <div class="swiper member-swiper swiper-reveal js-swiper-reveal"
                 id="swiper-div-{{ $division->id }}">
                ...
                {{-- Navigation & pagination scoped to this swiper --}}
