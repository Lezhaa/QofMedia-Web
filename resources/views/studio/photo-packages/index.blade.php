...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('studio.photo-packages.create') }}"
...
@section('content')
    ...
    <div class="stats-bar">
        <div class="stat-chip">
            ...
            Total Paket: <strong>{{ isset($packages) ? $packages->total() : 0 }}</strong>
        </div>
        <div class="stat-chip">
            <i class="fas fa-star" style="color:#D97706;"></i>
            Populer: <strong style="color:#D97706;">{{ isset($packages) ? $packages->getCollection()->where('is_popular', true)->count() : 0 }}</strong>
        </div>
        <div class="stat-chip">
            <i class="fas fa-layer-group"></i>
            Halaman ini: <strong>{{ isset($packages) ? $packages->count() : 0 }}</strong>
        </div>
    </div>
                    ...
                    <tbody>
                        @foreach($packages as $package)
                            <tr class="pkg-row"
                                ...
                                data-popular="{{ $package->is_popular ? 'populer' : 'reguler' }}">
                                ...
                                <td>
                                    <div style="display:flex; align-items:center; justify-content:center; gap:6px;">
                                        <a href="{{ route('studio.photo-packages.edit', $package) }}"
                                           class="act-btn edit" title="Edit">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <form action="{{ route('studio.photo-packages.destroy', $package) }}"
