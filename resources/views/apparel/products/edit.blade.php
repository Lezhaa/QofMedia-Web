...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('apparel.products.index') }}"
...
@section('content')
    ...
    <form action="{{ route('apparel.products.update', $product) }}" method="POST" enctype="multipart/form-data" id="mainForm">
                    ...
                    <div class="form-card-body">
                        ...
                        <div>
                            ...
                            <textarea name="description"
                                      ...
                                      placeholder="Tuliskan deskripsi singkat produk...">{{ old('description', $product->description) }}</textarea>
                            @error('description')
                                <div class="invalid-msg"><i class="fas fa-exclamation-circle"></i> {{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="type" id="type" class="form-control-custom" required>
                                ...
                                <option value="kaos"  {{ old('type', $product->type) == 'kaos'  ? 'selected' : '' }}>Kaos (Dengan Edisi/Varian)</option>
                            </select>
                        </div>
                        <div class="row g-2">
                            <div class="col-6">
                                ...
                                <div class="input-prefix-wrap">
                                    ...
                                    <input type="number" name="price"
                                           class="form-control-custom {{ $errors->has('price') ? 'is-invalid' : '' }}"
                            ...
                            <div class="col-6">
                                ...
                                <input type="number" name="stock"
                                       class="form-control-custom {{ $errors->has('stock') ? 'is-invalid' : '' }}"
        ...
        <div class="form-card">
            <div class="form-actions">
                ...
                <a href="{{ route('apparel.products.index') }}" class="btn-cancel">
    ...
    @if(isset($product->images) && $product->images->count() > 0)
        ...
        <div class="form-card">
            <div class="form-card-header">
                ...
                <div>
                    ...
                    <div class="form-card-header-sub">{{ $product->images->count() }} foto tersimpan — edit label atau hapus</div>
                </div>
            </div>
            <div class="form-card-body">
                    ...
                    @foreach($product->images as $img)
                        <div class="exist-gallery-item">
                            ...
                            <div class="exist-gallery-item-body">
                                ...
                                {{-- Update Label --}}
                                <form action="{{ route('apparel.products.updateImageLabel', $img->id) }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="exist-gallery-actions">
                                        ...
                                        {{-- Delete (inline form di dalam form tidak valid HTML, gunakan button terpisah) --}}
                                        <button type="button"
        ...
        {{-- Hidden delete forms --}}
        @foreach($product->images as $img)
            <form id="deleteImageForm{{ $img->id }}"
                  action="{{ route('apparel.products.deleteImage', $img->id) }}"
